...
python -m lm_eval.run_models --model hf \
    --model_args pretrained=meta-llama/Llama-3.1-8B,cq_codebook_dir=/home/zz359/workspace-CQ-zzy/LLMSim-CQ-zzy/output/llama-3.1-8b-4c8b/centroids,attn_implementation=eager \
    --tasks winogrande \
    --batch_size auto \
    --device cuda:2 \
    --verbosity INFO \
